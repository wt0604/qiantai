...
<head>
    ...
    <script type="text/javascript" src="<%=path %>/js/chengs/jquery.js"></script>
    <script type="text/javascript" src="<%=path %>/js/chengs/bootstrap.js"></script>
    <script type="text/javascript" src="<%=path %>/js/chengs/city-picker.data.js"></script>
    <script type="text/javascript" src="<%=path %>/js/chengs/city-picker.js"></script>
    <script type="text/javascript" src="<%=path %>/js/chengs/main.js"></script>
</head>
<body>
<!--侧边-->
...
<div id="header">
    <div class="header-box">
        ...
        <ul class="header-right">
            <li class="denglu">Hi~<a class="red" href="<%=path %>/dengl.html">请登录!</a> <a href="zhuc.html">[免费注册]</a></li>
            <li class="shu"></li>
            ...
            <ul>
                ...
                <li>
                    <div class="lieb_neir_kuang">
                        <div class="lieb_img">
                            <a href="#" onclick="tiaotiao1(${l.goodsid})"><img src="http://192.168.3.149:8080${l.goodsimg}"></a>
                            <div class="p_focus"><a class="J_focus" href="#" onclick="tiaotiao1(${l.goodsid})"><i></i>关注</a></div>
                        </div>
                        <div class="lieb_text">
                            <div class="p_price">
                                <strong class="J_price"><em>¥</em><i>${l.goodsprice}</i><em class="shangp_yuanj zuo_ji">¥</em><i class="shangp_yuanj">1099.00</i></strong>
                            </div>
                        </div>
                        <div class="shangp_biaot_">


                            <a href="#" onclick="tiaotiao1(${l.goodsid})">${l.goodsname}/${l.goodsinfo}</a>


                        </div>
                            <script>
                                function tiaotiao1(id){

                                    location.href = "<%=path %>/test/queryInfo?id="+id
