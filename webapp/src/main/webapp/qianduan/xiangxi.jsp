...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=path %>/houl/jquery.fancybox-1.3.4.css">
    <link rel="stylesheet" type="text/css" href="<%=path %>/houl/style.css">
    ...
    <script type="text/javascript" src="<%=path %>/houl/jquery.fancybox-1.3.4.js"></script>
...
<div class="gome_container">
    ...
    <div class="prd_firstscreen_left">
        ...
        <div id="magnifier">
            <div class="small-box">
                <img src="http://192.168.3.149:8080${info.goodsimg}">
    ...
    <div class="prd_firstscreen_center">
        <div class="hgroup">
            <h1>${info.goodsname} ${info.goodsgg}</h1>
        </div>
        <div class="prd_price_1">
            <div class="unitprice">
                ...
                <p>
                    ...
                    <span class="price"><em>¥</em>${info.goodsprice}</span>
                </p>
            </div>
        ...
        <div class="prd_properties">
            <div class="prd_properties_1">
                ...
                <span>由天狗自营发货并负责售后服务。</span>
            </div>
            <div class="prd-properties-2">
                <div class="prd_properties_other">
                    <label class="prdLeft">${info.goodsgg}</label>
                    <div class="prdRight">
        ...
        <div class="shangp_xiangq_left_biank">
            <div class="stores-infos">
                <div class="ly-stores">
                    ...
                    <div class="btn-group">
                        <a href="#" class="btn-product btn-enter" target="_blank"><i></i>进入首页</a>
                        <a href="#" class="btn-collect"><i class="sprite-enter"></i>收藏网站</a>
                    </div>
                </div>
            </div>
            <!---->
            <div class="dianp_xiao_jiej">
                <div class="shangj_diz">
                    <p>地址：<span>北京市金科公司</span></p>
                    <p>联系人：<span>肖逸</span></p>
                    <p>电话：<span>0852-8667011</span></p>
                    <p>营业时间：<span>24小时</span></p>
                </div>
                <div class="_xq_gogns_jianj">
                    <p>公司简介：</p>
                    <p class="_xq_gogns_jianj_neir">
            ...
            <div class="stores-infos">
                <div class="ly-stores">
                    ...
                    <ul class="bend_shangp_lieb">
                        ...
                        <li>
                            <a href="#" onclick="tiaotiao2(${l.goodsid})">
                                <img src="http://192.168.3.149:8080${l.goodsimg}">
                                <h3>${l.goodsprice}</h3>
                                <p>${l.goodsname}！</p>
                            </a>
                        </li>
